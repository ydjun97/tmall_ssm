            ...
            <td class="addPictureTableTD">
                    ...
                    <div class="panel-body">
                        <form class="addFormSingle" action="admin_productImage_add" method="post" enctype="multipart/form-data">
                            <table class="addTable">
                                ...
                                <tr>
                                    <td><input id="filepathSingle" type="file" name="image" accept="image/*" /></td>
                                </tr>
                                <tr class="submitTR">
                                    <td align="center">
                ...
                <table class="table table-striped table-bordered table-hover  table-condensed">
                    ...
                    <c:forEach items="${pisSingle}" var="pi">
                        <tr>
                            <td>${pi.id}</td>
                            <td><a href="img/productSingle/${pi.id}.jpg" title="点击查看原图">
                                <img height="50px" src="img/productSingle/${pi.id}.jpg" />
                            </a></td>
                            <td><a deleteLink="true" href="admin_productImage_delete?id=${pi.id}">
