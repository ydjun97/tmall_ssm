                    ...
                    <td>
                        ...
                        <c:if test="${o.status == 'waitDelivery'}">
                            <a href="admin_order_delivery?id=${o.id}">
                                <input type="button" class="btn btn-primary btn-xs" value="发货">
                            </a>
                        </c:if>
                    </td>
                </tr>
                            ...
                            <table width="800px" align="center" class="orderPageOrderItemTable">
                                <c:forEach items="${o.orderItems}" var="oi" varStatus="st">
                                    <tr>
                                        ...
                                        <td><a href="foreproduct?pid=${oi.pid}">
                                            ${oi.product.name}
                                        </a></td>
                                        <td align="right">
                                        ...
                                        <td align="right">
                                            <span class="text-muted">
                                                单价：￥<fmt:formatNumber type="number" value="${oi.product.promotePrice}" minFractionDigits="2" />
                                            </span>
                                        </td>
                                    </tr>
                                </c:forEach>
