...
<script>
    $(function(){
        ...
        $("img.smallImage").mouseenter(function(){
            var src = $(this).attr("bigImageSrc");
            $("img.bigImg").attr("src", src);
        });
        $("img.bigImg").load(function(){
            $("img.smallImage").each(function(){
                var img = new Image();
                img.src = $(this).attr("bigImageSrc");
    ...
    <div class="imgInimgAndInfo">
        ...
        <div class="smallImageDiv">
            <c:forEach items="${p.productSingleImages}" var="pi">
                <img class="smallImage" bigImageSrc="img/productSingle/${pi.id}.jpg"
    ...
    <div class="infoInimgAndInfo">
        ...
        <div class="productPrice">
            ...
            <div class="productPriceDiv">
                ...
                <div class="originalDiv">
                    ...
                    <span class="originalPrice"><fmt:formatNumber value="${p.originalPrice}" minFractionDigits="2" /></span>
                </div>
                <div class="promotionDiv">
                    <span class="promotionPriceDesc">促销价</span>
                    <span class="promotionPriceYuan">￥</span>
                    <span class="promotionPrice"><fmt:formatNumber value="${p.promotePrice}" minFractionDigits="2" /></span>
                </div>
            </div>
        </div>
        ...
        <div class="productNumber">
            ...
            <span>
                ...
                <span class="arrow">
                    <a href="#nowhere" class="increaseNumber" ><span class="updown">
                        <img src="img/site/increase.png" />
                    </span></a>
                    <span class="updownMiddle"> </span>
                    <a href="#nowhere" class="decreaseNumber"><span class="updown">
