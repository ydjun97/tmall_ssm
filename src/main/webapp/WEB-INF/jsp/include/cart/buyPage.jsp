        ...
        <table class="productListTable">
            ...
            <c:forEach items="${ois}" var="oi" varStatus="st">
                <tr class="orderItemTR">
                    ...
                    <td><span class="orderItemProductPrice">
                        ￥<fmt:formatNumber value="${oi.product.promotePrice}" minFractionDigits="2" />
                    </span></td>
                    <td><span class="orderItemProductNumber">
                            ${oi.number}
                    </span></td>
                    ...
                    <c:if test="${st.count == 1}">
                        <td class="orderItemLastTD" colspan="5">
                            <label class="orderItemDeliveryLabel">
                                <input type="radio" checked="checked" />
                                普通配送
                            </label>
                            <select class="orderItemDeliverySelect form-control1">
